...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post user_details_url, params: { user_detail: { nickname: @user_detail.nickname, profile: @user_detail.profile, user_id: @user_detail.user_id } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { nickname: @user_detail.nickname, profile: @user_detail.profile, user_id: @user_detail.user_id } }
